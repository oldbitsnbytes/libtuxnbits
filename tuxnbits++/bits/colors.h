...
#include <tuxnbits++/bits/export.h>
#include <vector>
#include <map>
#include <string>
...
struct LIBTUXNBITS color {
    ...
    struct LIBTUXNBITS elements
    {
        std::string name{};

        elements() = default;
        elements(const std::string& group_name);
        ~elements();
